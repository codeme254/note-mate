        ...
        <header className="landing-nav__header">
            ...
            <nav className="landing-nav__nav">
                <ol className="landing-nav__nav-list">
                    <li className="landing-nav__nav-list--item"><a href="">home</a></li>
                    <li className="landing-nav__nav-list--item"><a href="">about</a></li>
                    <li className="landing-nav__nav-list--item"><a href="">features</a></li>
